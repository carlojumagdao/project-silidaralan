...
$results = $conn -> query(" SELECT strSchCode, strSchDesc, strPrincipal, strMobile, strTelephone FROM tblSchool;");
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">School <a style="margin-bottom:1%" href="addschool.php" class="btn btn-primary">Create</a></h1>
                                    ...
                                    <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                        ...
                                        <tbody>
                                           <?php foreach ($data as $datum) { ?>
                                            <tr>
                                                <td class = "code"><?php echo $datum['strSchCode']?></td>
                                                <td><?php echo $datum['strSchDesc']?></td>
                                                <td><?php echo $datum['strPrincipal']?></td>
                                                <td><?php echo $datum['strMobile']?></td>
                                                <td><?php echo $datum['strTelephone']?></td>
                                                <td>
