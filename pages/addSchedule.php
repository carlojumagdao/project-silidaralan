    ...
    <div id="wrapper">
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">New Schedule 
                                    ...
                                    <form class="center-form" role="form">
                                        <div class="col-sm-10">
                                            <div class="form-group required">   
                                                <label class="control-label" for="schedulecode">Schedule Code</label>
                                                <input required="required" title="" name = "schedulecode" class = "form-control" type="text" placeholder="Schedule Code">     
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-5">
                                            <div class="form-group required">
                                                ...
                                                <input required="required" title="" name = "timestart" class = "form-control" type="time">
                                            </div>
                                        </div>
                                        <div class="col-sm-5">  
                                            <div class="form-group required">
                                                <label class="control-label">Time End</label>
                                                <input required="required" title="" name = "timeend" class = "form-control" type="time">
                                            </div>
                                        </div>
                                        <div class="col-sm-5">
                                            <div class="form-group required">
                                        ...
                                        <div class="col-sm-5">   
                                            <div class="form-group"> 
                                                <label class="form-group required">&nbsp</label>
                                                <div class="checkbox">
                                                    <label><input type="checkbox" value="thurs">Thursday</label>
                                                </div>
                                                <div class="checkbox">
